...
export default function Navbar() {
  ...
  return (
    <header className="kaytech-nav-enter fixed inset-x-0 top-4 sm:top-6 z-50 flex justify-center px-4">
      <div className={`flex w-full max-w-[1120px] items-center justify-between gap-4 rounded-nav border border-[var(--color-border)] bg-[var(--color-surface)]/80 px-4 py-2.5 shadow-[0_8px_24px_-12px_rgba(11,16,32,0.25)] transition-[backdrop-filter,box-shadow,background-color] duration-300 sm:px-6 ${scrolled ? "backdrop-blur-[64px] backdrop-saturate-150 bg-[var(--color-surface)]/88 shadow-[0_18px_42px_-16px_rgba(11,16,32,0.42)]" : "backdrop-blur-md"}`}>
