  ...
  return (
    <Section>
      ...
      <div className="mt-10 flex flex-col gap-4 sm:flex-row">
        <div className="flex flex-1 items-center justify-between rounded-card border border-[var(--color-border)] bg-[var(--color-surface)] p-6">
        ...
        <div className="flex flex-1 items-center rounded-card border border-[var(--color-border)] p-6">
